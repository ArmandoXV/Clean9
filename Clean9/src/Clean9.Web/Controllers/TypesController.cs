...
namespace Clean9.Web.Controllers
{
    public class TypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TypeName,Id")] Clean9.Core.Entities.Type @type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TypeName,Id")] Clean9.Core.Entities.Type @type)
        {
            if (id != @type.Id)
            {
                return NotFound();
